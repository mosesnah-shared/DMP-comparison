...
set( a2, 'fontsize', 30, 'xlim' ,[1, 4'], 'ylim', [-0.5, 1.5] )
...
set( a3, 'fontsize', 30, 'xlim' ,[1, 4'], 'ylim', [-0.5, 1.5] )
...
% ylabel( ani.hAxes{ 1 }, 'Y (m)', 'fontsize', 30 )
% 
% plot( a2, data_raw2.t_arr, data_raw2.q_arr, 'color', c.black, 'linewidth', 3 )
% set( a2, 'fontsize', 30, 'xlim', [1, 5 ], 'ylim', [ -1, 2], 'xticklabel', {}  )
