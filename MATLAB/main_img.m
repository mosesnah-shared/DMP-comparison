...
set( gca, 'xlim', [ 0, 1.5 ], 'ylim', [0, 1.1], 'fontsize', 30 )
...
subplot( 2, 2, 3 )
hold on
plot( data_move{ 1 }.t_arr, data_move{ 2 }.g( : ,2 ), 'linewidth', 2, 'linestyle', '--', 'color', c.black )
plot( data_move{ 1 }.t_arr, data_move{ 2 }.g0( :, 2 ), 'linewidth', 2, 'color', c.black )
...
subplot( 2, 2, 2 )
hold on
plot( data_motor{ 1 }.t_arr, data_motor{ 1 }.q0_arr( 1, :), 'linewidth', 3, 'linestyle', '--', 'color', c.black )
plot( data_motor{ 1 }.t_arr, data_motor{ 1 }.q_arr( 1, : ), 'linewidth', 4, 'color', c.orange )
set( gca, 'xlim', [0, 22.0], 'ylim', [0.0, 2.0 ], 'fontsize', 30  )
ylabel( '$q_1(t)$ (rad)', 'fontsize', 30 )
title( 'Elementary Dynamic Actions', 'fontsize', 30 )
...
tmp1 = load( '/Users/mosesnah/Documents/projects/DMP-comparison/results/discrete_and_rhythmic_task/motor/ctrl_task_imp.mat' );
tmp2 = load( '/Users/mosesnah/Documents/projects/DMP-comparison/results/discrete_and_rhythmic_task/movement/ctrl_task_dmp.mat' );
...
if mode == "MOTOR" || mode == "BOTH" 
    ...
    text( 0.03, 1.82, 'Goal $\mathbf{g}$','fontsize', 20 )
    text( -0.15,1.8,'L')
    legend( 'F', 'I,J', 'K,L', 'location', 'southwest' )
